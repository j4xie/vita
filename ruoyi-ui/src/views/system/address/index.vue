<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="收件人号码" prop="mobile">
        <el-input
      ...
      <el-form-item label="所属用户" prop="createByName">
        <el-input
    ...
    <el-table v-loading="loading" :data="addressList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="收件人号码" align="center" prop="mobile" width="150">
        <template slot-scope="scope">
          <span>+{{scope.row.intAreaCode + scope.row.mobile}}</span>
        </template>
      </el-table-column>
      <el-table-column label="收货地址" align="center" prop="address" width="240">
        <template slot-scope="scope" >
          <span v-if="scope.row.detailAddr">{{scope.row.address + scope.row.detailAddr}}</span>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="国家代码" prop="intAreaCode">
          <el-input v-model="form.intAreaCode" placeholder="请输入国家代码" />
        </el-form-item>
        <el-form-item label="收件人号码" prop="mobile">
          <el-input v-model="form.mobile" placeholder="请输入收件人号码" />
        </el-form-item>
