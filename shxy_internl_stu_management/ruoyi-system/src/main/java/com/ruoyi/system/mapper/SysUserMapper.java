...
public interface SysUserMapper
{
     ...
     * @return
     */
    public int updateUserVerifyEmail(@Param("userId") Long userId, @Param("isEmailVerify") Integer isEmailVerify);
     ...
     * @return
     */
    public int resetUserPwdByPhoneNumber(@Param("phonenumber") String phonenumber, @Param("password") String password);
