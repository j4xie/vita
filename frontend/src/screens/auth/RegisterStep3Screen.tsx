...
export const RegisterStep3Screen: React.FC = () => {
  ...
  const [errors, setErrors] = useState<Partial<Step3FormData>>({});

  const updateFormData = <K extends keyof Step3FormData>(
    field: K, 
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const registrationData: RegistrationAPIRequest = {
        ...
        orgId: step2Data.selectedOrganization!.id,
        area: detectedRegion,
        areaCode: '86', // 固定为中国区号
      ...
      if (response.code === 200) {
        ...
        try {
          ...
          if (loginResult.code === 200 && loginResult.data) {
            ...
            Alert.alert(
              ...
              t('auth.register.success.manual_login', { email: step2Data.email }),
              [{
        ...
        Alert.alert(
          t('auth.register.student.failed_title'),
          response.msg || t('auth.register.student.failed_message'),
          [
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.contentView}>
        ...
        <View style={styles.progressContainer}>
          ...
          <Text style={styles.progressText}>{t('auth.register.form.progress', { current: 3, total: 3 })}</Text>
        </View>
