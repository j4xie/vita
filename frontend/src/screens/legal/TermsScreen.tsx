...
export const TermsScreen: React.FC = () => {
  ...
  // 硬编码内容作为备用（测试用）
  const fallbackContent = isTerms ? `PomeloX 服务条款
...
欢迎使用PomeloX！我们是专为赴美留学生和家长打造的一站式服务与安全平台。从行前准备到在地生活，从活动报名到紧急协同，我们致力于为留学全周期提供专业服务。
...
PomeloX 平台的所有内容，包括软件代码、界面设计、商标标识等，均受知识产权法保护，归PomeloX所有。
...
本服务条款受中华人民共和国法律管辖。我们致力于为海外中国学生提供优质的服务体验。` : `PomeloX 隐私政策
...
欢迎使用PomeloX！我们深知个人信息保护的重要性，承诺严格遵守《中华人民共和国个人信息保护法》等相关法律法规。
