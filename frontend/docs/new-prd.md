l# PomeloX Phase 0 产品需求文档 (PRD)

## 项目概述
PomeloX 是为海外中国学生组织打造的综合性活动管理和报名平台，包含移动端用户应用、管理后台系统和志愿者管理功能。采用推荐码注册系统，为用户提供便捷的活动参与体验，为管理员提供完善的组织管理工具。
...
### 概述
管理服务端采用开源框架搭建，为PomeloX平台提供完整的后台管理功能。该系统主要用于系统管理员和组织管理员进行平台运营和用户管理。
