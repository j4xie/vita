      ...
      <Animated.View style={[styles.container, { bottom: insets.bottom + 70 }, containerAnimatedStyle]}>
        ...
        {!isPerformanceDegraded && (
          <>
            {/* 外层柔和发光 - 温和版 */}
            <Animated.View
              style={[styles.glowLayerOuter, glowAnimatedStyle, { pointerEvents: "none" }]}
            />
            {/* 内层强化发光 - 温和版 */}
            <Animated.View
              style={[styles.glowLayer, glowAnimatedStyle, { pointerEvents: "none" }]}
            />
          </>
        )}
            ...
            <Animated.View style={styles.blurContainer}>
              ...
              >
                ...
                {!isPerformanceDegraded && !optimizedStyles.simplifiedAnimations && (
                  <Animated.View
                    style={[styles.shimmer, shimmerAnimatedStyle, { pointerEvents: "none" }]}
                  />
                )}
